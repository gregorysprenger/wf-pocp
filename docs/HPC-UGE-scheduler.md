...
![workflow](images/wf-pocp_workflow.png)
...
```
git clone https://github.com/bacterial-genomics/wf-pocp.git $LAB_HOME/workflows
```
...
```
# BLAST (POCP)
run_POCP_BLAST_ALL_vs_ALL.uge-nextflow INPUT_DIRECTORY OUTPUT_DIRECTORY

# DIAMOND
run_POCP_DIAMOND_ALL_vs_ALL.uge-nextflow INPUT_DIRECTORY OUTPUT_DIRECTORY
```
...
```
# BLAST (POCP)
run_POCP_BLAST_QUERY_vs_REF.uge-nextflow QUERY_INPUT_FILE REFERENCE_DIRECTORY OUTPUT_DIRECTORY

# DIAMOND
run_POCP_DIAMOND_QUERY_vs_REF.uge-nextflow QUERY_INPUT_FILE REFERENCE_DIRECTORY OUTPUT_DIRECTORY
```
