//
// This file holds several functions specific to the main.nf workflow in the wf-pocp pipeline
//
...
class WorkflowMain {
    ...
    public static String citation(workflow) {
        return "If you use ${workflow.manifest.name} for your analysis please cite:\n\n" +
            ...
            "  https://github.com/bacterial-genomics/wf-pocp/blob/main/CITATIONS.md"
    }
