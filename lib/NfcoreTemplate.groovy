...
class NfcoreTemplate {
    ...
    public static void email(workflow, params, summary_params, projectDir, log) {
        ...
        def output_d = new File("${params.outdir}/log")
        if (!output_d.exists()) {
            output_d.mkdirs()
        }
    ...
    public static String logo(workflow, monochrome_logs) {
        ...
        String.format(
            ...
            ${colors.blue}                       __     __  __  __ __  ${colors.reset}
            ${colors.blue}                  |  ||_  __ |__)/  \\/  |__) ${colors.reset}
            ${colors.blue}                  |/\\||      |   \\__/\\__|    ${colors.reset}

            ${colors.green}   Perform Percentage of Conserved Proteins (POCP)
